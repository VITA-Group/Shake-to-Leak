...
class StableDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        for i, t in enumerate(timesteps[:-1]):
            ...
            latents = self.scheduler.reverse(noise_pred, t, timesteps[i + 1], latents, **extra_step_kwargs).prev_sample
        ...
        for i, t in enumerate(timesteps[:-1]):
            ...
            # compute the previous noisy sample x_t -> x_t-1
            latents = self.scheduler.step(noise_pred, t, timesteps[i + 1], latents, **extra_step_kwargs).prev_sample
